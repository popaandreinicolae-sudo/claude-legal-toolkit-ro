...
MODELUL SI ACTUL VECHI ALE UTILIZATORULUI SE VERIFICA PE LEGEA LA ZI. Ce iti da el, un act dintr-un dosar mai vechi, un model de contract, o clauza, un statut sau o cerere-tip, a fost verificat pentru legea din ziua in care a fost scris. Reutilizarea nu mosteneste verificarea. Aplica aceiasi patru pasi ca la doctrina: dateaza documentul, adu legea la zi pe ordinea surselor cu sintact intai, compara cele doua momente in istoricul de consolidare, modificat, completat, abrogat sau renumerotat dupa republicare, si confrunta cu legea la zi fiecare afirmatie sprijinita pe lege. Verifica temeiurile citate si textul de lege reprodus, termenele si procedura, competenta si denumirea autoritatii, sumele, plafoanele si taxele, cerintele de forma, si jurisprudenta invocata in model, care poate fi depasita intre timp de un recurs in interesul legii, de o hotarare prealabila sau de o decizie a Curtii Constitutionale. Verificarea nu iti da voie sa ii rescrii textul: ce nu se mai confirma se semnaleaza in conversatie, cu actul modificator si cu forma de azi, iar ce ramane neconfirmat poarta [NEVERIFICAT]. Prezumtia in favoarea lui se pastreaza, deci inainte de a spune ca a citat gresit verifica pe sintact si uita-te daca nu a scris corect pentru legea din vremea lui. DATAREA NU INCHIDE VERIFICAREA: modelul poate purta un viciu din nastere, iar comparatia intre cele doua momente nu il arata. Confrunta fiecare clauza sprijinita pe lege cu legea in vigoare, pe fond, si acolo unde legea rezerva o competenta unui organ anume verifica fiecare atribuire in parte. Pe 24 august 2026 un statut de asociatie dadea consiliului director sapte atributii rezervate adunarii generale de art. 21 alin. (2) din OG nr. 26/2000, mostenite dintr-un model preluat ca atare, iar o verificare care parcursese doar lista de nulitate din art. 6 alin. (2) le declarase in regula.
